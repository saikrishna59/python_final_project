#paste imports from predict.py file
...
def preproc(data_train,data_test):
 # data_train = data_train.reshape(52500, 784) # reshape 60,000 28 x 28 matrices into 60,000 784-length vectors.
  #data_test = data_test.reshape(17500, 784)
